...
import com.hxs.expandedcalendarview.view.LockScrollView
import com.hxs.expandedcalendarview.view.OnSwipeTouchListener
import java.util.*


@SuppressLint("ClickableViewAccessibility")
abstract class NewUICalendar constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
...
//    }
    ...
    init {
        ...
        val rootView = mInflater.inflate(R.layout.widget_collapsible_calendarview_new, this, true)
...
//    }
    ...
    abstract fun changeToToday(calendar: Calendar)
